...
<body>
	<header>
		<div class="container">
			<img src="{{asset('/img/thanks/woman.png')}}" alt="" />
			<div class="right two">
				<h1><span class="name">{{$name}}</span>, поздравляю!</h1>
	...
	<main>
		<div class="video_course">
			...
			<div class="container">
				<div class="left">
					...
					<div class="time"><img src="{{asset('/img/thanks/clock.png')}}" alt="" />90-минутный видеокурс:</div>
					<h2>“Что такое Проблемы 
					и как научиться их 
					решать быстро 
					и легко”</h2>
				</div>
				<img class="right" src="{{asset('/img/thanks/DVD.png')}}" alt="" />
			</div>
		...
		<div class="get">
			<div class="container">
				<p class="text">Потратив 1,5 часа своей жизни и 7$, вы узнаете алгоритмы решения любых проблем. А главное, сэкономите в будущем огромное количество времени, ресурсов и сил и направите их на создание счастливой жизни, а не на борьбу с «ветряными мельницами». <img src="{{asset('/img/thanks/sun.png')}}" alt="" /></p>
			</div>
		</div>
	</main>
	<div class="access">
