...
<body>
	<header>
		<div class="container">
			...
			<div class="img-form">
				<div class="img">
					<img src="{{asset('/img/header/1.webp')}}" alt="" class="wow jackInTheBox" data-wow-delay="100ms" />
					<img src="{{asset('/img/header/2.webp')}}" alt="" class="wow jackInTheBox" data-wow-delay="200ms" />
					<img src="{{asset('/img/header/3.webp')}}" alt="" class="wow jackInTheBox" data-wow-delay="300ms" />
					<img src="{{asset('/img/header/youtube.webp')}}" alt="" class="youtube wow jackInTheBox" data-wow-delay="600ms" />
				</div>
	...
	<main>
		...
		<div class="way">
			<img src="{{asset('/img/way/bg2.webp')}}" alt="" class="bg" />
			<div class="container">
				<div class="right">
					<h2>Кто пройдет 
					этот путь с вами </h2>
		...
		<div class="certificate">
			...
			<div class="container">
				...
				<div class="slider">
					<div class="item">
						<img src="{{asset('/img/certificate/1.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/2.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/3.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/4.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/5.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/6.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/7.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/8.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/9.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/10.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/11.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/12.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/13.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/14.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/15.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/16.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/17.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/18.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/19.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/20.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/21.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/22.webp')}}" alt="" />
						<div class="border"></div>
					</div>
					<div class="item">
						<img src="{{asset('/img/certificate/23.webp')}}" alt="" />
						<div class="border"></div>
					</div>
				</div>
				<button class="button form-trigger">Зарегистрироваться</button>
		...
		<div class="reviews2">
			...
			<div class="container">
				...
				<div class="slider">
					<div class="item">
						<div class="photo">
							<img src="{{asset('/img/reviews/photo.webp')}}" alt="" />
						</div>
