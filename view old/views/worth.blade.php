...
<body>
	...
	<main>
		<div class="container">
			<div data-fancybox href="https://www.youtube.com/watch?v=1QfRYnoh-CY" class="left"><img src="{{asset('/img/worth/1.webp')}}" alt="" /><img src="{{asset('/img/worth/play.webp')}}" alt="" class="play" /></div>
			<div class="right">
				<div data-fancybox href="https://www.youtube.com/watch?v=1QfRYnoh-CY" class="item">
					<div class="num">
						<div class="circle">1</div>
					</div>
					<img src="{{asset('/img/worth/play.webp')}}" alt="" class="play" />
				...
				<div class="item lock">
					...
					<img src="{{asset('/img/worth/lock.webp')}}" alt="" class="play" />
